...
export type ServerSidebarCategoryFilter = Record<
  'types' | 'states',
  { id: string; label: string; icon?: keyof typeof iconMap }[]
>
...
export function ServerSidebarCategory({
  categories,
}: {
  categories: ServerSidebarCategoryFilter
}) {
                    ...
                    <button
                      ...
                      onClick={() =>
                        setFilter((current) => {
                          ...
                          const keyData = currentKey.includes(item.id)
                            ? currentKey.filter((id) => id !== item.id)
                            : [...currentKey, item.id]
                          const newData = {
                            ...data,
                          ...
                          return newData.types === undefined &&
                            newData.states === undefined
                            ? null
                            : newData
                        })
                      }
