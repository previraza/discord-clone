export default {
  ...
  'modal.create_server.description':
    'Give a unique and descriptive name to your Kyaghanda along with an image for the server icon. You can always change it later!',
  ...
  'modal.create_server.server_name_description':
    'This is the name of your Kyaghanda',
  ...
  'modal.invite.description':
    'Share this link with your friends and colleagues and invite them to join your server.',
  ...
  'modal.initial.description':
    'Give a unique and descriptive name to your server along with an image for the server icon. You can always change it later!',
  ...
  'chat.welcome.channel.description':
  ...
  'join_server.success_description':
    'You will be redirected to this space in a moment.',
  ...
  'join_server.action.error.not_logged_in':
    'You must be logged in to join this space',
